  ...
  return (
    <>
      ...
      <div ref={ringRef} style={{
        ...
        width: hov ? 40 : 26, height: hov ? 40 : 26, borderRadius:'50%',
    ...
    <div style={{ position:'fixed', inset:0, overflow:'hidden', pointerEvents:'none', zIndex:0 }}>
      {items.map((item, i) => (
        <div key={i} style={{
          ...
          <div style={{
            width: 110, height: 130, background: '#faf8f4',
            boxShadow: '0 4px 20px rgba(0,0,0,0.1), 0 1px 4px rgba(0,0,0,0.06)',
            borderRadius: 4, padding: '10px 10px 28px',
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        @keyframes floatMem {
          from { opacity:0.55; transform:translateY(0px); }
          to   { opacity:0.75; transform:translateY(-14px); }
        }
        @keyframes spin {
        ...
        .sign-in-btn:not(:disabled):hover {
          background:#2a2a2a; transform:scale(1.015);
        ...
        .google-btn {
          ...
          letter-spacing:0.03em; color:rgba(17,17,17,0.55);
          text-decoration:none;
          transition:border-color 0.2s, color 0.2s, background 0.2s;
        }
        .google-btn:hover {
          border-color:rgba(17,17,17,0.4); color:#111;
      ...
      <div style={{
        ...
        <div className={loaded ? 'fu-1' : ''} style={{ opacity: loaded ? undefined : 0, marginBottom:28, textAlign:'center' }}>
          <a href="/" style={{
            ...
            letterSpacing:'-0.05em', color:'#111', textDecoration:'none',
          }}>gathrd</a>
        </div>
        ...
        <div className={`card ${loaded ? 'fu-2' : ''}`} style={{ opacity: loaded ? undefined : 0 }}>
          ...
          <div style={{ marginBottom:30, textAlign:'center' }}>
            <h1 style={{
              ...
              color:'#111', letterSpacing:'-0.02em', lineHeight:1.15, marginBottom:8,
            }}>Welcome back.</h1>
            <p style={{
              fontFamily:"'Syne',sans-serif", fontSize:13,
              color:'rgba(17,17,17,0.38)', letterSpacing:'0.01em',
            }}>Sign in to your memories</p>
          </div>

          {/* Error — original message strings preserved */}
          {error && (
            <div style={{
          ...
          {/* Form — original onSubmit, original field names */}
          ...
          <div style={{ display:'flex', alignItems:'center', gap:14, margin:'22px 0' }}>
            ...
            <span style={{
              ...
              letterSpacing:'0.14em', textTransform:'uppercase', color:'rgba(17,17,17,0.26)',
            }}>or</span>
            <div style={{ flex:1, height:1, background:'rgba(17,17,17,0.09)' }} />
          </div>

          {/* Google — native NextAuth provider URL, no JS added */}
          <a href="/api/auth/signin/google" className="google-btn">
        ...
        {/* Sign Up link — original href="/signup", original text */}
        <div style={{
          marginTop:24, textAlign:'center',
          fontFamily:"'Syne',sans-serif", fontSize:13, color:'rgba(17,17,17,0.38)',
        }}>
