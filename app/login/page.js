...
function Cursor() {
  ...
  useEffect(() => {
    ...
    const onOver = (e) => {
      if (e.target.closest('a,button,input,label')) setHov(true);
    };
    const onOut = (e) => {
      if (e.target.closest('a,button,input,label')) setHov(false);
    };
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          borderRadius: '50%',
          border: `1.5px solid ${
            hov ? 'rgba(17,17,17,0.38)' : 'rgba(17,17,17,0.18)'
          }`,
          transform: 'translate(-50%,-50%)',
    ...
    <>
      ...
      <div
        style={{
          ...
          pointerEvents: 'none',
          background:
            'radial-gradient(ellipse 70% 60% at 50% 44%, rgba(200,185,160,0.22) 0%, transparent 100%)',
        }}
      />
